...
gg.change+
geom_segment(aes(
chromStart+0.5, chromMean, xend=chromEnd+0.5, yend=chromMean, color=model),
...
In the above example we take "Kmax" as length of end vector from opart_poisson as Segmentor provides models with all possible change points till Kmax. Since, we want to compare it with the model produced by opart_poisson we take the model containing same number of changepoints from Segmentor.
