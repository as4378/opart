...
Since, "rate" is 100 at end of the loop it means that all models produced by opart_poisson match with Segmentor3IsBack.
...
In this section we will analyze how the runtime varies with increasing values of lambda for both opart_poisson and Segmentor3IsBack.
