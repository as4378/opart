...
From the [fpop paper](https://link.springer.com/article/10.1007/s11222-016-9636-3) we can understand the idea behind optimal partitioning as follows:
...
p <- ggplot(data = timing.dt, aes(x = (timing.dt$length), 
                             y = (timing.dt$time), 
                             col = timing.dt$expr))+
  geom_smooth() +
